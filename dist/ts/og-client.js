...
//   return typeof client === 'object' && client !== null && (client as any)[SUI_CLIENT_BRAND] === true
// }
...
//    */
//   async getCoins({ coinType, owner, cursor, limit, signal }: GetCoinsParams): Promise<PaginatedCoins> {
...
//    */
//   async call<T = unknown>(method: string, params: unknown[], { signal }: { signal?: AbortSignal } = {}): Promise<T> {
...
//     })
//   }
//   async multiGetTransactionBlocks(input: MultiGetTransactionBlocksParams): Promise<SuiTransactionBlockResponse[]> {
...
//    */
//   async getLatestSuiSystemState({ signal }: GetLatestSuiSystemStateParams = {}): Promise<SuiSystemStateSummary> {
//     return await this.transport.request({
...
//    */
//   async queryEvents({ query, cursor, limit, order, signal }: QueryEventsParams): Promise<PaginatedEvents> {
...
//    */
//   async devInspectTransactionBlock(input: DevInspectTransactionBlockParams): Promise<DevInspectResults> {
...
//     const { nextCursor, hasNextPage, data }: ResolvedNameServiceNames = await this.transport.request({
...
//   }
// }
//# sourceMappingURL=og-client.js.map
