...
class SandboxClient {
    ...
    executeTransactionBlock(input) {
        const txBytes = typeof input.transactionBlock === 'string'
    ...
    dryRunTransaction(transactionBlock) {
        const txBytes = typeof transactionBlock === 'string' ? transactionBlock : Buffer.from(transactionBlock).toString('base64');
